...
DblClick = function() {
  ...
  this.initialize = function () {
    ...
    $($document.body).on(EVENT_NAME, this.syncBrowserEvent);
    return this;
  };
  this.tearDown = function() {
    // EventSync.removeEvent($document.body, EVENT_NAME, this.syncBrowserEvent);
    $($document.body).off(EVENT_NAME, this.syncBrowserEvent);
  };
  ...
  this.syncBrowserEvent = function (event) {
    ...
    if (canEmit) {
      var filters = EventSync._eventFilters['dblclick'];
